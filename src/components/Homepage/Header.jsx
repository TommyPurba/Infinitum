  ...
  return (
    <div className=" bg-secondary flex justify-between items-center px-6 py-4">
      ...
      <div className=" flex justify-center items-center gap-2 font-medium">
        ...
        <button className="buttonAnimation" onClick={handleClick}>Log in</button>
        <button className="px-6 py-2 text-paraghraph-text font-semibold rounded-full bg-button-hover hover:opacity-75" onClick={handleClickSignup}>
          Sign Up
        </button>
      </div>
    </div>
